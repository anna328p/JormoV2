...
void viewWalletMsg()
{
    std::cout << InformationMsg("Please remember that when using a view wallet "
              ...
              << std::endl << "This means if you received 100 JOR and then "
              << "sent 50 JOR, your balance would appear to still be 100 "
              << "JOR." << std::endl
...
void connectingMsg()
{
    std::cout << std::endl << "Making initial contact with jormocoind."
              << std::endl
