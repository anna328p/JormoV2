         ...
         Config &config)
{
    ...
    do
    {
        std::cout << InformationMsg("JormoCoin v"
    ...
    {
        std::cout << WarningMsg("It looks like jormocoind isn't open!")
                  << std::endl << std::endl
                  << WarningMsg("Ensure jormocoind is open and has finished "
                                "initializing.")
                  << std::endl
                  << WarningMsg("If it's still not working, try restarting "
                                "jormocoind. The daemon sometimes gets stuck.") 
                  << std::endl
                  << WarningMsg("Alternatively, perhaps jormocoind can't "
              ...
              bool &alreadyShuttingDown)
{
    ...
    {
        std::cout << "Patience buddy, we're already shutting down!" 
                  << std::endl;
        return false;
    }
    else
