...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(360000000000000);
...
const uint64_t DEFAULT_DUST_THRESHOLD                        = UINT64_C(3);
...
const int      P2P_DEFAULT_PORT                              =  17326;
const int      RPC_DEFAULT_PORT                              =  18326;
